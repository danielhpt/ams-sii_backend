...
urlpatterns = [
    ...
    path('victims/<int:victim_id>/procedure_ventilation/', VictimProcedureVentilationList.as_view(),
         name="victim_procedure_ventilation"),
    path('victims/<int:victim_id>/procedure_protocol/', VictimProcedureProtocolList.as_view(),
         name="victim_procedure_protocol"),
    path('victims/<int:victim_id>/procedure_circulation/', VictimProcedureCirculationList.as_view(),
