...
urlpatterns = [
    ...
    # path('api/victims/<int:victim_id>/pharmacies/', None, name="victim_pharmacy_list"),
    # path('api/victims/<int:victim_id>/pharmacies/<int:pharmacy_id>/', None, name="victim_pharmacy_detail"),
    # path('api/victims/<int:victim_id>/evaluations/', None, name="victim_evaluation_list"),
    # path('api/victims/<int:victim_id>/evaluations/<int:evaluation_id>/', None, name="victim_evaluation_detail"),
