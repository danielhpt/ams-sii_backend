...
urlpatterns = [
    # API
    path('api/users/', None, name="user_list"),  # admin only?
    ...
    path('api/teams/', None, name="team_list"),  # admin only?
    path('api/teams/<int:team_id>/', None, name="team_detail"),
    path('api/teams/<int:team_id>/occurrences/', None, name="team_occurrences_list"),
    path('api/occurrences/', None, name="occurrence_list"),  # admin only?
    path('api/occurrences/<int:occurrence_id>/', None, name="occurrence_detail"),
    path('api/occurrences/<int:occurrence_id>/victims/', None, name="occurrence_victims_list"),
    path('api/victims/<int:victim_id>', None, name="victim_detail"),
